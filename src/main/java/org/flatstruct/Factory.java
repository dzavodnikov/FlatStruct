...
public abstract class Factory<T> {
    ...
    protected final DynamicClassLoader CLASS_LOADER = new DynamicClassLoader();
     ...
     */
    abstract public byte[] createImpl(String className);
    ...
    public Class<?> createImpl(final Class<T> classDef) {
        ...
        final byte[] classBytes = createImpl(className);
        return CLASS_LOADER.defineClass(className, classBytes);
    }
